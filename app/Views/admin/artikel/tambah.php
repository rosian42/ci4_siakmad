                        ...
                        <form class="form-horizontal" id="form_simpan" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" class="form-control" id="post_title" placeholder="Judul Artikel"
...
<!--<script src="<?=base_url('assets/admin');?>/plugins/bootstrap-tagsinput/bootstrap-tagsinput-angular.min.js"></script>-->
<!-- Select2 -->
