                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                        class="form-control <?=($validation->hasError('tahun_akademik'))?'is-invalid':'';?>"
                                        id="tahun_akademik" name="tahun_akademik" placeholder="2022-2023"
                                        value="<?php echo (isset($tahun_akademik))?$tahun_akademik:""?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="semester"
                                        class="form-control select2 <?=($validation->hasError('semester'))?'is-invalid':'';?>">
                                        <option></option>
                                        <option value="1"
                                            <?php echo (isset($semester) && $semester=="1")?"selected":"";?>> Ganjil
                                        </option>
                                        <option value="2"
                                            <?php echo (isset($semester) && $semester=="2")?"selected":"";?>> Genap
                                        </option>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="is_aktif"
                                        class="form-control select2 <?=($validation->hasError('is_aktif'))?'is-invalid':'';?>">
                                        <option></option>
                                        <option value="Y"
