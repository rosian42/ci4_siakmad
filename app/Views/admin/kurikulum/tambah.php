                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                        class="form-control <?=($validation->hasError('nm_kurikulum'))?'is-invalid':'';?>"
                                        id="nm_kurikulum" name="nm_kurikulum" placeholder="Misal : Kurikulum K-13"
                                        value="<?php echo (isset($nm_kurikulum))?$nm_kurikulum:''?>">
