              ...
              <form class="form-horizontal" action="" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control <?=($validation->hasError('id_tingkatan_kelas'))?'is-invalid':'';?>" id="id_tingkatan_kelas" name="id_tingkatan_kelas" placeholder="Misal : 1" value="<?php echo (isset($id_tingkatan_kelas))?$id_tingkatan_kelas:old('id_tingkatan_kelas')?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control <?=($validation->hasError('nm_tingkatan_kelas'))?'is-invalid':'';?>" id="nm_tingkatan_kelas" name="nm_tingkatan_kelas" placeholder="Tingkat Kelas 1 (I)" value="<?php echo (isset($nm_tingkatan_kelas))?$nm_tingkatan_kelas:old('nm_tingkatan_kelas')?>">
                      <div class="invalid-feedback">
