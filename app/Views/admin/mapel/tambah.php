              ...
              <form class="form-horizontal" action="" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control <?=($validation->hasError('kd_mapel'))?'is-invalid':'';?>" id="kd_mapel" name="kd_mapel" placeholder="Misal : MTK" value="<?php echo (isset($kd_mapel))?$kd_mapel:''?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control <?=($validation->hasError('nm_mapel'))?'is-invalid':'';?>" id="nm_mapel" name="nm_mapel" placeholder="Mis.: Matematika" value="<?php echo (isset($nm_mapel))?$nm_mapel:''?>">
                      <div class="invalid-feedback">
