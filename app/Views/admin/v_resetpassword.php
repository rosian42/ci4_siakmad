                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputPasswordKonfirmasi" type="password" placeholder="Konfirmasi Password" name="konfirmasi_password"/>
                                                <label for="inputPasswordKonfirmasi">Konfirmasi Password</label>
                                            </div>
                                            
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="<?=site_url('admin/login');?>">Kembali Ke Login</a>
