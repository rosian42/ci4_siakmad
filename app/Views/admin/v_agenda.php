	        ...
	        <div class="modal-body">
	            <div class="form-group row ">
	              ...
	              <div class="col-sm-9">
	                  ...
	                  <input type="text" class="form-control" id="post_title" placeholder="Judul Artikel" name="post_title" >
	              ...
	              <div class="col-sm-9">
	                  ...
	                  <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" id="event_date"
                            data-toggle="datetimepicker" name="event_date"
	            ...
	            <div class="form-group row ">
	              ...
	              <div class="col-sm-9">
	                  <textarea class="form-control summernote" id="post_content" name="post_content" ></textarea>
