            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="<?php echo set_post_link('21');?>">About</a></li>
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="<?php echo set_post_link('24');?>">Sample Post</a></li>
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                    	<?php if ($type == 'artikel'){
                            ...
                            <span class="meta">
                                ...
                                on <?php echo tgl_indonesia($tanggal)?>
                            </span>
                        </div>
