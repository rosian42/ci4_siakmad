        ...
        <div class="ed-mob-menu">
            <div class="ed-mob-menu-con">
                <div class="ed-mm-left">
                    <div class="wed-logo">
                        <a href="#"><img src="<?=(empty(konfigurasi_get('logo')['konfigurasi_value']))?base_url(konfigurasi_get('logo')['konfigurasi_default']):base_url(konfigurasi_get('logo')['konfigurasi_value']);?>" alt="" />
                        </a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ed-com-t1-left">
                            <ul>
                                <li><a href="#">Alamat: <?=(empty(konfigurasi_get('alamat_sekolah')['konfigurasi_value']))?konfigurasi_get('alamat_sekolah')['konfigurasi_default']:konfigurasi_get('alamat_sekolah')['konfigurasi_value'];?></a>
                                </li>
                                <li><a href="#">Telepon: <?=(empty(konfigurasi_get('no_telp')['konfigurasi_value']))?konfigurasi_get('no_telp')['konfigurasi_default']:konfigurasi_get('no_telp')['konfigurasi_value'];?></a>
                                </li>
                                <li><a href="#">Email: <?=(empty(konfigurasi_get('email')['konfigurasi_value']))?konfigurasi_get('email')['konfigurasi_default']:konfigurasi_get('email')['konfigurasi_value'];?></a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="top-logo" data-spy="affix" data-offset-top="250">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="wed-logo">
                            <a href="index-2.html"><img src="<?=(empty(konfigurasi_get('logo')['konfigurasi_value']))?base_url(konfigurasi_get('logo')['konfigurasi_default']):base_url(konfigurasi_get('logo')['konfigurasi_value']);?>" alt="" />
                            </a>
                        </div>
                        <div class="main-menu">
                            <ul>
                                                ...
                                                <div class="mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay menu-about" href="admission.html">
                                                            <img src="<?=base_url('assets/front');?>/images/h-about.jpg" alt="">
                                                            <span>Academics</span>
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="about.html">
                                                            <img src="<?=base_url('assets/front');?>/images/h-about1.jpg" alt="">
                                                            <span>Academics</span>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="admission.html">
                                                            <img src="<?=base_url('assets/front');?>/images/h-adm1.jpg" alt="">
                                                            <span>Admission</span>
                                                        </a>
                                                    </div>
                                                    <p>Donec lacus libero, rutrum ac sollicitudin sed, mattis non eros. Vestibulum congue nec eros quis lacinia. Mauris non tincidunt lectus. Nulla mollis, orci vitae accumsan rhoncus.</p>
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="awards.html">
                                                            <img src="<?=base_url('assets/front');?>/images/h-cam1.jpg" alt="">
                                                ...
                                                <div class="mm2-com mm1-com mm1-s4">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="seminar.html">
                                                            <img src="<?=base_url('assets/front');?>/images/h-res1.jpg" alt="">
