...
class KurikulumModel extends Model
{
    ...
    protected $allowedFields    = ['nm_kurikulum', 'is_aktif'];
    ...
    */
    ...
    protected $column_order = ['id_kurikulum', 'nm_kurikulum'];
    protected $column_search = ['nm_kurikulum'];
    protected $order = ['id_kurikulum' => 'DESC'];
    protected $request;
    protected $db;
    protected $dt;
